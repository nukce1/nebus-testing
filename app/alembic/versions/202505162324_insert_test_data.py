...
def upgrade() -> None:
    ...
    op.bulk_insert(
        ...
        [
            ...
            {'id': 6, 'name': 'ООО Здесь может быть ваша реклама', 'phone': '2-222-222, 3-333-333, 8-923-666-13-13', 'building_id': 3},
            ...
            {'id': 11, 'name': 'ОООЕда и Автомобили', 'phone': '2-222-222, 3-333-333, 8-923-666-13-13', 'building_id': 6},
        ]
    )
